...
export function GoogleButton() {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 border border-border bg-white hover:bg-paper-dark text-ink font-medium py-3 rounded transition-colors text-sm"
    >
