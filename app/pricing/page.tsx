...
const PLANS = [
  ...
  },
  {
    ...
    name: "Studio",
    price: 49,
    priceId: process.env.NEXT_PUBLIC_PADDLE_PRICE_STUDIO!,
    blurb: "Up to 3 team members",
  },
]
          ...
          {PLANS.map((plan) => (
            ...
            >
              ...
              <p className="font-display text-3xl text-ink my-3">
                ${plan.price}
                <span className="text-sm text-slate-mid font-sans">
                  /mo
                </span>
              </p>
              ...
              {profile?.plan === plan.key ? (
                <div className="text-center text-sm text-slate-mid py-2.5 border border-border rounded-lg">
                  Current plan
                </div>
              ) : plan.priceId ? (
                <UpgradeButton
